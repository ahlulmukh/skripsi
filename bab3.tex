...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=10cm]{collecting-weapon.png}
        \caption{Weapon Collecting}
        \label{fig:weapon-collecting}
    \end{figure}
    \begin{figure}[h]
        \centering
        \includegraphics[width=10cm]{collecting-karakter.png}
        \caption{Karakter Collecting}
        \label{fig:karakter-collecting}
    \end{figure}
    \begin{figure}[h]
        \centering
        \includegraphics[width=10cm]{collecting-map.png}
...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=7cm]{case-diagram.png}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=14cm]{class-diagram-perancangan.png}
...
\begin{longtblr}[caption = {\textit{Story Board}}]{
  ...
  Id & Deskripsi & Gambar \\
  1 & {Bagian main menu \\akan menampilkan \\menu utama game} & \includegraphics[scale=0.10]{mainmenustory} \\
  2 & {Bagian didalam room \\akan menampilkan \\player} & \includegraphics[scale=0.10]{in-room-story} \\
  3 & {Bagian didalam pencarin \\room menampilkan list\\ room} & \includegraphics[scale=0.10]{listroomstory} \\
  4 & {Bagian didalam pembuatan \\room } & \includegraphics[scale=0.10]{cari-Roomstory} \\
\end{longtblr}
...
\subsection{Pengujian sinkronisasi permainan}
\noindent

Pada teknik pengujian sinkronisasi melakukan pengujian pada pergerakan player, pengurangan darah player, penambahan statistik leaderboard dan \textit{time over} pada permainan secara sinkronisasi antar client.

\subsection{Pengujian Pengguna}
\noindent

Pada pengujian ini yaitu untuk melakukan pengujian terhadap pengguna pada masing masing device yang berbeda untuk mengetahui performa dan kesesuaian gui pada masing masing device. Pengujian ini dilakukan dengan mengamati langsung dari teman/kerabat terdekat.
