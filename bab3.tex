...
\begin{longtblr}[caption = {\textit{Story Board}}]{
  ...
  Id & Deskripsi & Gambar \\
  1 & {Bagian main menu \\akan menampilkan \\menu utama game} & \includegraphics[scale=0.15]{menuutama} \\
  2 & {Bagian didalam room \\akan menampilkan \\player} & \includegraphics[scale=0.15]{pengujianroom} \\
  3 & {Bagian didalam game \\saat game selesai} & \includegraphics[scale=0.15]{roundover} \\
\end{longtblr}
