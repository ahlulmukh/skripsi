...
\begin{table}[h]
    ...
    Realme 7    & Sesuai                                                              \\ \hline
    \end{tabular}
    \end{table}

Dapat dilihat pada tabel \ref{tb:tabel-interface}, dari hasil pengujian yang telah dilakukan tampilan GUI dari hasil rancangan sesuai dengan device-device yang berbeda, tidak ada pergeseran interface pada masing masing device yang telah diuji. Dapat dilihat pada gambar, pengujian dari salah satu device yaitu poco x3 pro.
\newpage
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{pocox3pro.jpg}
    \caption{Tampilan GUI Device Poco X3 Pro}
    \label{fig:pocox3pro-interface}
\end{figure}
